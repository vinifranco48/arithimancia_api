...
exports.schoolsData = void 0;
exports.seedSchools = seedSchools;
exports.cleanSchools = cleanSchools;
...
async function seedSchools() {
    ...
    for (const school of exports.schoolsData) {
    ...
    console.log(`✅ Seeded ${exports.schoolsData.length} schools`);
}
